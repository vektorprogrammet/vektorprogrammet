...
final class Version20181119182727 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD reservedFromPopUp TINYINT(1) NOT NULL, ADD lastPopUpTime DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE survey ADD showCustomPopUpMessage TINYINT(1) NOT NULL, ADD teamSurvey TINYINT(1) DEFAULT \'0\' NOT NULL, ADD surveyPopUpMessage LONGTEXT NOT NULL, CHANGE showCustomFinishPage showCustomFinishPage TINYINT(1) NOT NULL');
    }
