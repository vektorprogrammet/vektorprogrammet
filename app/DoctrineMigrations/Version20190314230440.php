 ...
 */
final class Version20190314230440 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE usergroup_collection (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, numberUserGroups INT NOT NULL, numberTotalUsers INT DEFAULT NULL, assistantBolks LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', deletable TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE survey_notifier (id INT AUTO_INCREMENT NOT NULL, survey_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, timeOfNotification DATETIME NOT NULL, notificationType INT NOT NULL, allSent TINYINT(1) NOT NULL, active TINYINT(1) DEFAULT \'0\' NOT NULL, smsMessage VARCHAR(255) NOT NULL, emailSubject VARCHAR(255) NOT NULL, emailMessage LONGTEXT NOT NULL, userGroup_id INT DEFAULT NULL, INDEX IDX_7A119AA22B674466 (userGroup_id), INDEX IDX_7A119AA2B3FE509D (survey_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE survey_notification (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, timeNotificationSent DATETIME DEFAULT NULL, userIdentifier VARCHAR(255) NOT NULL, sent TINYINT(1) NOT NULL, surveyNotifier_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_CF867A9A750FAC43 (userIdentifier), INDEX IDX_CF867A9AA76ED395 (user_id), INDEX IDX_CF867A9A45F6A4BB (surveyNotifier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
