...
final class Version20181023133033 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE semester DROP department_id, DROP admission_start_date, DROP admission_end_date, DROP semesterStartDate, DROP semesterEndDate, DROP infoMeeting_id');
