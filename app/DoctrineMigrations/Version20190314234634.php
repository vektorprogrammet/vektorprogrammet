 ...
 */
final class Version20190314234634 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_group_collection (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, number_of_user_groups INT NOT NULL, number_of_total_users INT DEFAULT NULL, assistant_bolk LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', deletable TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE survey_notification (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, time_notification_Sent DATETIME DEFAULT NULL, user_identifier VARCHAR(255) NOT NULL, sent TINYINT(1) NOT NULL, surveyNotifier_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_CF867A9AD0494586 (user_identifier), INDEX IDX_CF867A9AA76ED395 (user_id), INDEX IDX_CF867A9A45F6A4BB (surveyNotifier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
