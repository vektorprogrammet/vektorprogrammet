...
import { fetchDepartments } from '../actions/department'; //For å sjekke aktiv søkeperiode
...
class AssistantPage extends Component {
    ...
    render()
    {
        let correctForm = <ApplicationFormContainer/>;

        if(this.props.departments.length < 1)
        {
            correctForm = <NewsletterFormContainer/>;
        }
