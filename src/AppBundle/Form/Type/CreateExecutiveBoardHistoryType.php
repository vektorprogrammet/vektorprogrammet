...
class CreateExecutiveBoardHistoryType extends AbstractType
{
    private $allDepartmentsId;

    public function __construct($allDepartmentsId)
    {
        $this->allDepartmentsId = $allDepartmentsId;
    }
            ...
            ->add('user', 'entity', array(
                ...
                'query_builder' => function (EntityRepository $er) {
                    return $er->createQueryBuilder('u')
                        ...
                        ->andWhere('d = ?1')
                        ->setParameter(1, $this->allDepartmentsId);
                },
            ))
    ...
    {
        return 'createExecutiveBoardHistory';
    }
}
