...
class GalleryController extends Controller{
    ...
    var $allowed_file_types = ['image/gif', 'image/jpeg', 'image/png', 'image/bmp'];
     ...
     * @return Response
     */
    public function galleriesListGetAction(){ //todo: change name to albumsListGetAction
     ...
     * @return Response
     */
    public function editAlbumAction($album_id){ //todo: change name
        $photos = $this->getDoctrine()->getRepository('AppBundle:Photo')->findBy(
            array('gallery' => $album_id),
            array('dateAdded' => 'ASC')
        );
     ...
     * @return Response
     */
    public function createGalleryAction(){ //todo: change name to createAlbumAction
        $request = Request::createFromGlobals();
