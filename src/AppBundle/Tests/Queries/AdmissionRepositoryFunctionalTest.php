...
class AdmissionRepositoryFunctionalTest extends KernelTestCase
{
    ...
    public function testFindInterviewedApplicants()
    {
        ...
        $applications = $this->em->getRepository('AppBundle:Application')->findInterviewedApplicants(1,1);
    ...
    public function testFindAssignedApplicants()
    {
        ...
        $applications = $this->em->getRepository('AppBundle:Application')->findAssignedApplicants(1,1);
    ...
    public function testFindNewApplicants()
    {
        ...
        $applications = $this->em->getRepository('AppBundle:Application')->findNewApplicants(1,1);
