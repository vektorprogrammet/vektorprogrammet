...
class LoadImageData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $hyttetur10->setPath('/images/gallery_images/hytte10.jpg');
        ...
        $hyttetur11->setPath('/images/gallery_images/hytte11.jpg');
        ...
        $beste3->setPath('/images/gallery_images/beste3.jpg');
